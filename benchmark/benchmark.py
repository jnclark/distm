...
print('Benchmarking various calculations for {} 2D points'.format(points))

points = np.random.rand(points, 2).astype(np.float32)
...
matrix2 = distm.calcm_parallel(points)
